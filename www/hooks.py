...
app_description = "App that helps handles aircraft data, passenger data, and manage ticketing"
app_email = "glavindmello@gmail.com"
app_license = "mit"
...
fixtures = [
    {"dt": "DocType", "filters": [["name", "in", ["Airplane Route Price"]]]}
]
